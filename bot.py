...
RULES = {
	...
	"color": ["red", "green", "black", "white", "blue", "glittering", "orange", "yellow", "obsidian", "ivory", "ebon", "ebony"],
	...
	##################### Nouns #######################
	"real_animal": [ "amoeba", "virus", "bacteria", "anaconda", "ant", "bat", "bear", "bee", "bird", "brood", "bunny", "cat", "centipede", "cheetah", "chicken", "dinosaur", "dog", "eagle", "fish", "frog", "leech", "lizard", "maggot", "mantis", "mole", "piranha", "plant", "puma", "python", "rabbit", "raven", "scorpion", "seaweed", "serpent", "shark", "snake", "spider", "termite", "tiger", "turtle", "vine", "vulture", "wasp", "worm", ],
	"evil_group": [ "communist party", "illuminati", "secret society", "cabal", "unamerican activity", "lizard people", "mafia", "Vatican", "inner circle", "secret service", "CIA", "FBI", "Pentagon", "KGB", "congress", "SS", ],
	"battle": [ "attack", "revenge", "battle", "revolution", "hunt", "counterattack", "battlefield", "bloodbath", "mutiny", "invasion", "war", "massacre", "holocaust", ],
    "job": [ "alchemist", "architect", "autarch", "avenger", "baron", "biker", "bimbo", "boss", "bureaucrat", "butcher", "cannibal", "cheerleader", "clown", "commander", "commando", "communist", "cop", "crusader", "cultist", "czar", "defender", "detective", "diver", "duke", "duplicator", "emperor", "empress", "exorcist", "football player", "geisha", "gladiator", "goddess", "groupie", "harlot", "hunter", "invader", "king", "knight", "legionnaire", "librarian", "lord", "luchador", "master", "night", "ninja", "nun", "occultist", "pirate", "president", "priest", "prince", "princess", "private eye", "professor", "pyromaniac", "queen", "rabbi", "raider", "ronin", "samurai", "scientist", "secret agent", "seer", "servant", "slayer", "snatcher", "sorceror", "taxman", "trooper", "villager", "witch", "wizard", "astronaut", "barbarian", "commando", "conqueror", "cop", "destroyer", "judge", "raider", "rider", "soldier", "surgeon", "thief", "warlock", "superhero", "supervillain", "hero", "villain"],
	"food": [ "fruit", "water", "mushroom", "casserole", "toast", "mold", "egg", "tofu", ],
	"natural_phenomena": [ "ash", "cloud", "comet", "fire", "flood", "fog", "hail", "hurricane", "inferno", "mist", "pool", "rain", "sandstorm", "shadow", "snow", "summer", "tornado", "typhoon", "vapor", "water", "wind", "winter", "smoke", "smog"],
    "shapes": [ "color", "element", "colour", "orb", "chaos", "blob", "cube", "flash", "form", "monolith", "sphere", ],
	"spooky_objects_tools_or_weapons": [ "armor", "blade", "candy", "crown", "crystal ball", "drill", "gun", "hammer", "helm", "key", "lance", "mace", "masque", "plate", "rifle", "ring", "saber", "scepter", "shield", "shovel", "sword", "trapdoor", "mask", "capsule", ],
	"technology": [ "android", "blade", "car", "computer", "doll", "effect", "elevator", "factory", "gear", "hologram", "laser", "machine", "mystereon", "plane", "puppet", "robot", "rocket", "saucer", "ship", "battleship", "tank", "science", "spaceship", "starship", "statue", "toy", "truck", "tunnel", "ufo", "automaton", ],
    "fantasy_animal": [ "alien", "angel", "bigfoot", "chimera", "chupacabra", "cockatrice", "cyborg", "demon", "dragon", "elf", "fairy", "fury", "gargoyle", "ghost", "ghoul", "giant", "gnome", "goblin", "god", "golem", "gorgon", "gremlin", "grue", "hobgoblin", "homunculus", "hydra", "imp", "kobold", "kraken", "leprechaun", "lepus", "leviathan", "lich", "lictor", "lycanthrope", "mermaid", "merman", "monster", "mummy", "mutant", "ogre", "phoenix", "poltergeist", "santa claus", "sasquatch", "satyr", "shapeshifter", "siren", "soul", "spectre", "spirit", "stalker", "troll", "undead", "unicorn", "vampire", "werewolf", "wight", "yeti", "zombie", ],
	"humans": [ "man", "teenager", "girl", "boy", "woman", ],
	...
	"threatening_substance" : [ "drug", "cocaine", "blood", "slime", "poison", "elixir", "brew", "stuff", "grime", "oil", "slick", "ooze", "goop", "sludge", "goo", "ichor", ],
	# Todo: Add back gods
	"threat": [ "#food#", "#humans#", "#natural_phenomena#", "#ritual#", "#scary_phenomena#", "#spooky_objects_tools_or_weapons#", "#threatening_substance#", "#threatening_thing#", "#body_part#", "#fantasy_animal#", "#job#", "#real_animal#", "#technology#", ],
	"body_part": [ "blood", "bone", "bosom", "brain", "claw", "eye", "finger", "flesh", "foot", "gut", "hand", "heart", "jaw", "maw", "mind", "mouth", "muscle", "organ", "sinew", "skull", "spine", "stomach", "tendon", "tendril", "tentacle", ],
	"menacing_places_on_earth": [ "Egypt", "groom lake", "area 51", "the nile", "mesoptamia", "tampa", "siberia", "mongolia", "the outback", "the frozen north", "main street USA", "soviet russia", "L.A.", "Basque Country", "Bavaria", "The pacific", "the atlantic", "The Himalayas", "Tibet", "New Jersey", "yucca flats", "the north pole", "Antarctica", "the far east", "the Orient", "Babylonia", "the center of the earth", ],
	"scary_parts_of_a_house" : [ "attic", "basement", "bed", "cellar", "closet", "fireplace", "floorboards", "furnace", "kitchen", "room", "sewer", "shed", "stairs", "walls", "well", ],
	"story": [ "legend", "secret", "cycle", "fable", "fate", "saga", "tale", "tales", ],
	"moment_in_time": [ "day", "night", "year", "solstice", "time", "dawn", "rise", "dusk", ],
	"ritual": [ "#color# mass", "boogaloo", "dance", "festival", "funeral", "christmas", "opera", "orgy", "party", "pyre", "rite", "ritual", "sacrifce", ],
	"unpleasant_places" : [ "prison", "jail", "the suburbs", "the fair", "the silo", "the mall", "the science fair", "the DMV", "the library", ],
	"mythological_places" : [ "hell", "atlantis", "valhalla", "underworld", "the plane of leng", "miskatonic university", "Innsmouth", "hades", "avalon", "Shangra La", "El Dorado", "carcosa", "R'lyeh", "Omicron Persei #number#", "vulcan", ],
	"spooky_locale_without_the": [ "swamp", "island", "lake", "tower", "mountain", "hill", ],
	"spooky_locale": [ "barren", "barrier", "caldera", "carnival", "castle", "cave", "continent", "crater", "crypt", "dungeon", "field", "forest", "grave", "graveyard", "cemetery", "grotto", "hill", "hive", "island", "jungle", "keep", "kingdom", "lagoon", "lagoon", "lake", "mausoleum", "mine", "mountain", "rim", "ruin", "sands", "sepulcher", "shipwreck", "shores", "swamp", "throne", "tomb", "torture chamber", "tower", "valley", "vault", "volcano", "wilderness", "fortress", "labrynth", "pit", ],
	"water_and_oceans" :[ "the sea", "the deep", "the depths", "20,000 fathoms", "the reef"],
	"dwelling_place" : [ "village", "hotel", "house", "mansion", "fort", "town", "colony", "cabin", "city", "realm", "zone", "-ville", ],
	"religious_buildings" : [ "church", "the cathedral", "the pagoda", "the chapel", "the reliquary", "the synagogue", "the mosque", "the temple", ],
	"time_related" : [ "time", "the future", "forever", "tomorrow", "the year 2000", "the year 5000", "the year 10000", "the 41st Millennium", ],

	##################### Adjectives #######################
	"cosmic_adj" :[ "alien", "cosmic", "crawling", "endless", "eternal", "final", "gibbous", "gloaming", "groaning", "hoary", "indescribable", "infinite", "occult", "outer", "star", "stygian", "timeless", ],
	"decayed_adj" : [ "caustic", "acrid", "bubbling", "demolished", "diseased", "disgusting", "dying", "fetid", "melting", "one-eyed", "putrid", "rotting", ],
	"evil_adj" : [ "abominable", "aggressive", "corrupt", "dark", "deadly", "demonic", "depraved", "deranged", "dread", "evil", "ferocious", "godless", "grim", "haunted", "homocidal", "horrendous", "horrifying", "infernal", "inhuman", "insane", "insidious", "killer", "laughing", "lurking", "macabre", "mad", "remorseless", "satanic", "shadowy", "sinister", "skeletal", "spooky", "terrifying", "unstoppable", "vampiric", "violent", "mindless", "wrathful", "enraged", "furious", ],
	"horror_movie_adj" : [ "blood-soaked", "cannibal", "charnel", "grind-", "chainsaw", "bloody", "slasher", "gore-encrusted", ],
	...
	"material_adj" : [ "iron", "metal", "wax", "clay", "crystal", "bone", "hollow", "glowing", ],
	"natural_adj" : [ "albino", "amorphous", "backwoods", "blood-sucking", "chimeric", "dead", "flesh-eating", "fungal", "gelatinous", "heavy", "jungle", "living", "man-eating", "nocturnal", "protoplasmic", "rabid", "sentient", "starving", "untamed", "wild", "woodland", ],
	...
	"religion_or_culture_adj" : [ "Aztec", "Egyptian", "eastern", "western", "christian", "jewish", "holy", "sacred", "hebrew", "Mormon", "neanderthal", "heathen", "shamanistic", "Norse", "soviet", "communist", ],
	...
	"silly_adj" : [ "teenage", "surfing", "strange", "weird",],
	"size_related_adj": [ "micro", "micro-", "mega", "mega-", "shrinking", "giant", "transforming", "colossal", "titanic", "enormous", "indestructible", "mighty", ],
	"space_age_adj" : [ "robo-", "astro", "rocket", "solar", "neon", "space", "mecha-", "mechano-", "techno-", "electric", "electro-mechanical", "cybernetic", "stellar", "turbo", "uber", "photonic", "temporal", "holographic", "time", "transdimensional", "ultra", "futuristic", "techno", "space age", ],
	"undead_adj" : [ "undead", "reborn", "reanimated", ],
	"unseen_adj": [ "invisible", "immaterial", "empty", "phantasm", "phantom", "subterranean", "transparent", ],
	"wonderous_adj" : [ "amazing", "awesome", "fantastic", "glorious", "incredible", "mystical", "terrible", ],

	# Maybes
	"adverb": [ "of", "in", "that came from", "from", "before", "corrupted by", "from beyond", "on the edge of", "beyond", "inside", "above", "within"],
	"maybe_adj": [ "", "#adj#"],
	...
	"place": [
		...
		"#maybe_adj# #menacing_places_on_earth#",
