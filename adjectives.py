...
base_adjectives = {
    ...
    "material_adj" : ["ruby", "sapphire", "brass", "copper", "water", "fire", "earth", "stone", "iron", "metal", "stainless steel", "titanium", "aluminum", "cobalt", "plutonium", "thorium", "uranium", "gold", "silver", "lead", "wax", "clay", "crystal", "bone", "hollow", "glowing", "shining", "glittering", "stainless"],
    ...
    "sexploitation_adj": ["queer", "femme", "butch", "uptight", "gender", "nude", "perky", "moist", "sex-change", "sensual", "buxom", "well-endowed", "passionate", "transsexual", "foxy", "immoral", "kinky", "BDSM", "promiscuous", "raunchy", "dirty", "hedonistic", "desperate", "pent-up", "carnal", "freaky", "deviant", "fleshy", "sexy", "disco", "free-love", "pleasurable", "lavacious", "lecherous", "leather", "buff", "horny", "gay", "lesbian", "trans", "transvestite"],
    "space_age_adj" : ["modern", "chemical", "video", "film", "experimental", "light", "robo-", "astro", "rocket", "solar", "genetic", "neon", "space", "mecha-", "mechano-", "machine", "techno-", "electric", "electro-mechanical", "cybernetic", "stellar", "turbo", "photonic", "temporal", "holographic", "time", "transdimensional", "futuristic", "techno", "space age", ],
    ...
    "evil_adj" : ["killer", "twisted", "abominable", "aggressive", "corrupt",
                  "dark", "deadly", "demon", "demonic", "depraved", "dread",
                  ...
                  "macabre", "remorseless", "satanic", "shadowy",
    ...
    "crazy_adj": ["deranged", "mad", "crazy", "nutzoid", "bonkers", "mental"],

    "hippy_adj": ["vegetarian", "vegan", "psychedelic", "hippie", "trippy", "disorienting", "drugged-out"],
    ...
    "ordering": ["first", "last", "final", "third", "second"],
