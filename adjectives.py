...
base_adjectives = {
    ...
    "space_age_adj" : ["retro", "modern", "chemical", "video", "film", "experimental",
                       "light", "robo-", "astro", "rocket", "solar", "genetic",
                       "neon", "space", "mecha-", "mechano-", "machine",
                       "techno-", "electric", "electro-mechanical",
                       "mechanical", "cybernetic", "stellar", "turbo", "photonic", "temporal", "holographic", "time", "transdimensional", "futuristic", "techno", "space age", ],
