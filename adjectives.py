...
base_adjectives = {
    ...
    "wonderous_adj" : [ "fabulous", "amazing", "fantastic", "glorious", "incredible", "mystical", "terrible", ],
    ...
    "cosmic_adj": ["forever", "spectral", "shuddering", "silent", "ruined", "lovecraftian", "non-euclidean", "hallucinogenic", "terminal", "alien", "astral", "cosmic", "crawling", "endless", "eternal", "final", "gibbous", "groaning", "indescribable", "infinite", "occult", "outer", "stygian", "timeless" ],
