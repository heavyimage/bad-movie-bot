...
base_nouns = {
    ...
    # simple meta rules
    "ritual_or_event": ["sabbath", "#color# mass", "dance", "rave", "concert", "festival", "funeral", "christmas", "opera", "orgy", "party", "pyre", "rite", "ritual", "sacrifice", "circus", "carnival", "bazzar", "toast", "banquet", "dinner", "dance", "ball", "masquerade"],
