...
base_nouns = {
    ...
    "scheme": ["mutiny", "perversion", "study", "experiment", "destiny", "scheme", "grudge", "study", "plot", "revenge", "compact", "embrace", "pact", "bargain", "vigil", "betrayal", "lies", "promises", "wishes"],
    "concept": ["vice", "love", "horror", "beauty", "destiny", "evil", "doom", "damnation", "revenge", "madness", "damnation", "fear", "loathing", "wonder", "evil", "life", "chaos", "justice", "insanity", "nightmare", "hunger", "dream", "horror", "death", "urges", "fever", "consciousness", "nausea", "pain", "anguish", "eternity", "infinity", "sacrifice", "pestilence", "dogma", "courage", "vengence", "rage"],
    ...
    "natural_phenomena": ["avalanche", "planet", "galaxy", "comet", "sun", "star", "moon", "ash", "rainbow", "cloud", "comet",
						  ...
						  "rockslide", "plague", "outbreak", "pandemic"],
